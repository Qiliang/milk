...
exports.query = function (req, res) {
    ...
    Q.all([db.all('select sum(count) count,shop_name,name,price,proxy_name from outs_view where create_at>=$from and create_at<=$to group by shop_name,proxy_name', {$from: from_date, $to: to_date})
